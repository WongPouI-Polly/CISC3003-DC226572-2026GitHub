...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateActiveNavLink() {
        const currentPage = window.location.pathname.split('/').pop() || 'cisc3003-sugEx03-home.html';
        ...
        navLinks.forEach(link => {
            ...
            // Special case for cisc3003-sugEx03-home.html (home page)
            if (currentPage === '' || currentPage === 'cisc3003-sugEx03-home.html') {
                if (linkPage === 'cisc3003-sugEx03-home.html' || linkPage === '') {
                    link.classList.add('active');
                }
            }
        });
